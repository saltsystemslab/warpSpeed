...
namespace tables {
   ...
   struct iht_p2_bucket {
      ...
      using pair_type = iht_p2_pair<Key, Val>;
   ...
   struct iht_p2_table {
      ...
      using packed_pair_type = iht_p2_pair<Key, Val>;
      ...
      __host__ void print_space_usage(){
         ...
         capacity += host_version->n_buckets_alt*sizeof(bucket_type) + (host_version->n_buckets_alt-1)/8+1; 
